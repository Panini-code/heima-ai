...
public class CommonConfiguration {
    ...
    public ChatClient chatClient(AlibabaOpenAiChatModel model, ChatMemory chatMemory) {
        return ChatClient
                ...
                .defaultSystem("你是一个热心、可爱的智能助手，你的名字叫小团团。请用热情详细的语气回答用户的问题，不要每次在回答开头自我介绍。")
                .defaultAdvisors(
    ...
    @Bean
    public ChatClient pdfAgentChatClient(AlibabaOpenAiChatModel model, ChatMemory chatMemory, PdfSearchTool pdfSearchTool) {
        return ChatClient
                .builder(model)
                .defaultAdvisors(
                        new SimpleLoggerAdvisor(),
