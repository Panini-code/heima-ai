...
# Step 1: Replace history item template - match exact original text
old_block = """          <div 
...
# Use actual newline-separated text
old_lines = [
    '          <div ',
    '            v-for="chat in chatHistory" ',
    '            :key="chat.id"',
...
assert old_text in content, "OLD TEXT NOT FOUND!"
...
assert old in content, "CLOSE NOT FOUND!"
content = content.replace(old, new, 1)

# Step 3: TrashIcon import
